...
Som man kan se så er personer uten inntekt tatt med i dette datasettet. 
...
Her har vi laget den endelig modellen uten 2% topp inntekt og 0 inntekt. 
```{r}
...
# Konklusjon
Fra modellene kan vi konkludere med at høyde ikke har noe påvirkning på inntekt. 
